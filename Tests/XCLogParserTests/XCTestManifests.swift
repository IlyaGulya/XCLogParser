...
extension JSONWriterTests {
    static let __allTests__JSONWriterTests = [
        ("testBuildStepValuesMatchJSONEncoder", testBuildStepValuesMatchJSONEncoder),
        ("testBuildStepWritesTheSameFieldsAsJSONEncoder", testBuildStepWritesTheSameFieldsAsJSONEncoder),
        ("testDoubleFormattingMatchesJSONEncoder", testDoubleFormattingMatchesJSONEncoder),
        ("testEmptyArraysAreWrittenAsEmpty", testEmptyArraysAreWrittenAsEmpty),
        ("testIntegerFormatting", testIntegerFormatting),
        ("testNestedSubStepsAreWrittenDepthFirst", testNestedSubStepsAreWrittenDepthFirst),
        ("testNilOptionalsOmitTheKeyEntirely", testNilOptionalsOmitTheKeyEntirely),
        ("testNonFiniteDoublesBecomeNull", testNonFiniteDoublesBecomeNull),
        ("testOutputIsDeterministic", testOutputIsDeterministic),
        ("testPrettyPrintedShape", testPrettyPrintedShape),
        ("testStringEscapingMatchesJSONEncoder", testStringEscapingMatchesJSONEncoder)
    ]
}
...
extension StringTrimExtensionTests {
    static let __allTests__StringTrimExtensionTests = [
        ...
        ("testMatchesFoundationForEveryAsciiBoundary", testMatchesFoundationForEveryAsciiBoundary),
        ("testMatchesFoundationForNonAsciiWhitespace", testMatchesFoundationForNonAsciiWhitespace),
        ("testWhitespaceOnlyStringsBecomeEmpty", testWhitespaceOnlyStringsBecomeEmpty)
    ]
}
...
extension LexerTests {
    ...
    static let __allTests__LexerTests = [
        ("testTokenTypeByteInitMatchesRawValueInitForEveryByte",
         testTokenTypeByteInitMatchesRawValueInitForEveryByte),
        ("testTokenizeBytesMatchesTokenizeContentsOnFixtures",
         testTokenizeBytesMatchesTokenizeContentsOnFixtures),
        ("testTokenizeBytesMatchesTokenizeContentsOnGeneratedInput",
         testTokenizeBytesMatchesTokenizeContentsOnGeneratedInput),
        ("testTokenizeBytesMatchesTokenizeContentsWhenRewriting",
         testTokenizeBytesMatchesTokenizeContentsWhenRewriting),
        ("testTokenizeBytesRejectsWhatTokenizeContentsRejects",
         testTokenizeBytesRejectsWhatTokenizeContentsRejects),
        ("testTokenizeClassName", testTokenizeClassName),
        ("testTokenizeClassNameRefWithNoDeclaredClassThrowsRatherThanCrashing",
         testTokenizeClassNameRefWithNoDeclaredClassThrowsRatherThanCrashing),
        ("testTokenizeClassNameRefZeroThrowsRatherThanCrashing",
         testTokenizeClassNameRefZeroThrowsRatherThanCrashing),
...
extension JSONWriterParityTests {
    static let __allTests__JSONWriterParityTests = [
        ("testEveryWriterMatchesJSONEncoder", testEveryWriterMatchesJSONEncoder)
    ]
}
