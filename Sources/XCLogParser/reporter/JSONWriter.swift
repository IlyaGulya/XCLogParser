...
/// # Why this exists
///
/// `JSONEncoder` was 44-60% of the tool's runtime and `BuildStep.encode(to:)` alone was 32.1% of
...
struct JSONWriter {
    ...
    /// per number wider than a single digit, which measured as 52,118 allocations - 2.9% of the
